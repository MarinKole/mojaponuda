...
const FEDERAL_SOURCES: FederalSourceConfig[] = [
  ...
  },
  {
    ...
    issuer: "Federalno ministarstvo energije, rudarstva i industrije",
  },
  {
    name: "FMKS",
    baseUrl: "https://www.fmks.gov.ba",
    grantsPath: "/",
    location: "Federacija BiH",
    linkPattern: /poziv|konkurs|grant|poticaj/i,
    issuer: "Federalno ministarstvo kulture i sporta",
  },
  {
    name: "FMRSP",
    ...
    issuer: "Federalno ministarstvo rada i socijalne politike",
  },
  {
    name: "FIPA BiH",
    ...
    issuer: "Agencija za unapređenje stranih investicija BiH (FIPA)",
  },
  {
    name: "MVTEO BiH",
    ...
    location: "Bosna i Hercegovina",
    linkPattern: /poziv|grant|poticaj/i,
    issuer: "Ministarstvo vanjske trgovine i ekonomskih odnosa BiH",
  },
  {
    name: "Vlada RS",
  ...
  },
  {
    ...
    location: "Republika Srpska",
    linkPattern: /poziv|konkurs|grant|poticaj/i,
    issuer: "Razvojna agencija RS za mala i srednja preduzeća (RARS)",
  },
  {
  ...
  },
  {
    ...
    issuer: "EU Fondovi - Delegacija Europske unije u BiH",
  },
];
...
const SOURCE_ID_MAP: Record<string, string> = {
  ...
  "vlada-rs": "Vlada RS",
  "rars": "RARS RS",
  "mper-rs": "Republika Srpska - Ministarstvo privrede",
  "eu-fondovi": "EU Fondovi BiH",
};
