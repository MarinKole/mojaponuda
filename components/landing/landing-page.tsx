...
function PrimaryCTA({
  ...
  return (
    <Link
      ...
      className={`inline-flex h-14 items-center justify-center gap-2 rounded-full bg-primary px-8 text-base font-bold text-white shadow-xl shadow-blue-500/30 transition-all hover:bg-blue-700 hover:shadow-2xl hover:shadow-blue-500/40 hover:-translate-y-1 ${className}`}
    >
      {label}
    ...
    <nav className="fixed top-0 z-50 w-full border-b border-slate-200/80 bg-white/80 backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
        ...
        <div className="hidden items-center gap-8 md:flex">
          <a href="#kako-radi" className="text-sm font-semibold text-slate-600 transition-colors hover:text-primary">Kako radi</a>
          <a href="#usporedba" className="text-sm font-semibold text-slate-600 transition-colors hover:text-primary">Poređenje</a>
          <a href="#cijene" className="text-sm font-semibold text-slate-600 transition-colors hover:text-primary">Cijene</a>
        </div>

        <div className="flex items-center gap-4">
          {isLoggedIn ? (
            <Link href="/dashboard" className="rounded-full bg-primary px-5 py-2.5 text-sm font-bold text-white transition-all hover:bg-blue-700 hover:shadow-lg hover:shadow-blue-500/30 hover:-translate-y-0.5">
              Otvori Dashboard
            </Link>
          ) : (
            <>
              <Link href="/login" className="hidden text-sm font-bold text-slate-600 transition-colors hover:text-primary sm:block">
                Prijava
              </Link>
              <Link href="/signup" className="rounded-full bg-slate-900 px-5 py-2.5 text-sm font-bold text-white transition-all hover:bg-primary hover:shadow-lg hover:shadow-blue-500/30 hover:-translate-y-0.5">
                Isprobaj besplatno
              </Link>
            </>
          )}
...
function HeroSection({ isLoggedIn }: { isLoggedIn?: boolean }) {
  return (
    <section className="relative overflow-hidden bg-white px-6 pb-20 pt-32 sm:pb-28 sm:pt-40">
      ...
      <div className="relative mx-auto max-w-4xl text-center">
        ...
        <h1 className="font-heading text-4xl font-extrabold leading-[1.08] tracking-tight text-slate-900 sm:text-5xl lg:text-6xl mb-6">
        ...
        <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
          ...
          <p className="text-sm text-slate-500">Bez kreditne kartice · Od 50 KM/mj</p>
        </div>
        ...
        <div className="mt-12 grid gap-4 text-left sm:grid-cols-3">
          {[
            ...
            <div key={item.text} className="flex items-center gap-3 rounded-2xl border border-slate-100 bg-slate-50/60 px-4 py-3">
...
function HowItWorksSection() {
  ...
  return (
    <section id="kako-radi" className="bg-slate-50 px-6 py-20 sm:py-28 border-t border-slate-100">
      <div className="mx-auto max-w-6xl">
        <div className="text-center mb-14">
          <h2 className="font-heading text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
            Kako radi
          </h2>
          <p className="mt-3 text-lg text-slate-600">4 koraka od objave do predaje ponude.</p>
        </div>

        <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
          {steps.map((s) => (
            <div key={s.num} className="relative rounded-[2rem] border border-slate-200 bg-white p-7 shadow-sm transition-all hover:shadow-lg hover:-translate-y-1">
              <span className="text-xs font-bold text-blue-400 tracking-widest">{s.num}</span>
              <div className="mt-3 flex size-12 items-center justify-center rounded-2xl bg-blue-50 text-blue-600">
...
function BeforeAfterSection({ isLoggedIn }: { isLoggedIn?: boolean }) {
  return (
    <section id="usporedba" className="bg-white px-6 py-20 sm:py-28 border-t border-slate-100">
      <div className="mx-auto max-w-5xl">
        <div className="text-center mb-14">
          <h2 className="font-heading text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
            Koliko vremena gubite na jedan tender?
          </h2>
          <p className="mt-3 text-lg text-slate-600">Usporedba između ručnog rada i korištenja MojaPonuda.ba</p>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="rounded-[2rem] border border-red-100 bg-red-50/60 p-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <p className="text-xs font-bold uppercase tracking-wider text-red-400">Bez aplikacije</p>
                <p className="font-heading text-xl font-bold text-slate-900">2–5 sati po tenderu</p>
              </div>
            </div>
          ...
          {/* Sa aplikacijom */}
          <div className="rounded-[2rem] border border-emerald-200 bg-emerald-50/60 p-8">
            <div className="flex items-center gap-3 mb-6">
              <div className="flex size-10 items-center justify-center rounded-xl bg-emerald-100 text-emerald-600">
                <Zap className="size-5" />
              </div>
              <div>
                <p className="text-xs font-bold uppercase tracking-wider text-emerald-500">Sa MojaPonuda.ba</p>
                <p className="font-heading text-xl font-bold text-slate-900">20–45 minuta po tenderu</p>
              </div>
            </div>
            <ul className="space-y-3">
              {[
        ...
        <div className="grid gap-12 lg:grid-cols-2 items-center">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 mb-6">
              ...
              <span className="text-xs font-bold uppercase tracking-wider text-blue-300">ROI</span>
            </div>
            ...
            <div className="mt-8 space-y-4">
              {[
                ...
                <div key={item.text} className="flex items-start gap-3 rounded-xl border border-white/10 bg-white/5 p-4">
                  <item.icon className="mt-0.5 size-5 shrink-0 text-red-400" />
                  <span className="text-sm text-slate-300">{item.text}</span>
                </div>
              ))}
            </div>

            <div className="mt-8 rounded-2xl border border-blue-500/30 bg-blue-600/20 p-5">
              <p className="text-base font-bold text-white">MojaPonuda.ba to sprječava.</p>
          ...
          <div className="rounded-[2rem] border border-white/10 bg-white/5 p-8 backdrop-blur-sm">
            <p className="text-sm font-bold uppercase tracking-wider text-blue-300 mb-6">Vidite tačno šta trebate predati</p>
            <div className="space-y-3">
              {[
                ...
                <div key={item.text} className={`flex items-center gap-3 rounded-xl p-3 ${item.done ? "border border-white/5 bg-white/5" : "border border-red-500/30 bg-red-500/10"}`}>
                  ...
                  <span className={`text-sm ${item.done ? "text-slate-300" : "text-red-300 font-medium"}`}>{item.text}</span>
                </div>
              ))}
            </div>
            <p className="mt-5 text-xs text-slate-400">Vidite šta nedostaje — prije nego što je kasno.</p>
          </div>
        </div>
      </div>
    </section>
...
function PricingSection({ isLoggedIn }: { isLoggedIn?: boolean }) {
  return (
    <section id="cijene" className="bg-slate-50 px-6 py-20 sm:py-28 border-t border-slate-100">
      <div className="mx-auto max-w-6xl">
        <div className="text-center mb-14">
          <div className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-3 py-1 mb-4">
            <span className="text-xs font-bold text-slate-500">Od 50 KM miesečno</span>
          </div>
          <h2 className="font-heading text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
            Jasni paketi. Bez iznenađenja.
          </h2>
          <p className="mt-3 text-lg text-slate-600">Odaberite prema obimu rada. Bez dugoročnog ugovora.</p>
        </div>
        ...
        <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-3 lg:items-start">
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="mt-2 text-sm text-slate-500 min-h-[40px]">Pratite prilike. Plaćate samo kad se prijavljujete.</p>
            ...
            <p className="mt-1 text-xs text-amber-600 font-semibold">+ 15 KM po svakoj pripremi ponude</p>
            ...
            <Link href={isLoggedIn ? "/dashboard" : "/signup"} className="mt-8 flex w-full items-center justify-center rounded-full border border-slate-300 bg-white py-3 text-sm font-semibold text-slate-700 transition-all hover:bg-slate-50">
              Odaberi paket
            </Link>
          </div>

          {/* Puni Paket — highlighted */}
          <div className="relative rounded-3xl border-2 border-primary bg-white p-8 shadow-2xl shadow-blue-500/10 lg:scale-105 z-10">
            ...
            <p className="mt-2 text-sm text-slate-500 min-h-[40px]">Uzimate tendere bez greške. Sve je uključeno.</p>
            <div className="mt-5 flex items-baseline gap-1">
              <span className="font-heading text-5xl font-bold text-slate-900">99</span>
              <span className="text-sm font-medium text-slate-500">KM / mj.</span>
            </div>
            <p className="mt-1 text-xs text-emerald-600 font-semibold">Bez ikakvih dodatnih troškova</p>
            <div className="mt-6 space-y-3">
              {[
                ...
                <div key={f} className={`flex items-start gap-3 text-sm ${f.startsWith("Sve iz") ? "text-slate-400 font-medium" : "text-slate-700 font-medium"}`}>
                  <CheckCircle className={`mt-0.5 size-4 shrink-0 ${f.startsWith("Sve iz") ? "text-slate-300" : "text-primary"}`} />
                  {f}
                </div>
              ))}
            </div>
            <Link href={isLoggedIn ? "/dashboard" : "/signup"} className="mt-8 flex w-full items-center justify-center rounded-full bg-primary py-3.5 text-sm font-bold text-white transition-all hover:bg-blue-700 hover:shadow-lg hover:shadow-blue-500/30">
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="mt-2 text-sm text-slate-500 min-h-[40px]">Za agencije koje vode više firmi.</p>
            <div className="mt-5 flex items-baseline gap-1">
              <span className="font-heading text-4xl font-bold text-slate-900">149+</span>
              <span className="text-sm font-medium text-slate-500">KM / mj.</span>
            </div>
            <p className="mt-1 text-xs text-slate-400 font-medium">+25 KM po dodatnoj firmi</p>
            <div className="mt-6 space-y-3">
              {[
                "Sve iz Punog paketa +",
                ...
                <div key={f} className={`flex items-start gap-3 text-sm ${f.startsWith("Sve iz") ? "text-slate-400 font-medium" : "text-slate-600"}`}>
                  <CheckCircle className={`mt-0.5 size-4 shrink-0 ${f.startsWith("Sve iz") ? "text-slate-300" : "text-slate-400"}`} />
                  {f}
                </div>
              ))}
            </div>
            <Link href="/contact" className="mt-8 flex w-full items-center justify-center rounded-full border border-slate-300 bg-white py-3 text-sm font-semibold text-slate-700 transition-all hover:bg-slate-50">
              Kontaktirajte nas
            </Link>
          </div>
        </div>
...
function FAQSection() {
  return (
    <section className="bg-white px-6 py-20 sm:py-28 border-t border-slate-100">
        ...
        <div className="space-y-3">
          {FAQ_ITEMS.map((item) => (
            <details key={item.q} className="group rounded-2xl border border-slate-200 bg-slate-50 transition-colors hover:bg-slate-100">
              <summary className="flex cursor-pointer items-center justify-between p-5 text-base font-semibold text-slate-900 [&::-webkit-details-marker]:hidden">
                {item.q}
    ...
    <section className="relative overflow-hidden bg-slate-900 px-6 py-28 text-center">
      ...
      <div className="relative z-10 mx-auto max-w-2xl">
        ...
        <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
          <PrimaryCTA isLoggedIn={isLoggedIn} label="Pronađi moje tendere" className="!bg-white !text-slate-900 hover:!bg-slate-100 !shadow-white/20" />
          <p className="text-sm text-slate-400">Bez kreditne kartice · Od 49 KM/mj</p>
        </div>
      </div>
    </section>
  );
      ...
      <div className="mx-auto max-w-7xl">
        <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
          <div>
            ...
            <p className="mt-2 text-sm text-slate-500">© 2026 Sva prava zadržana.</p>
          </div>
          <div className="flex gap-8 text-sm text-slate-600">
            <Link href="/privacy" className="hover:text-primary">Politika privatnosti</Link>
            <Link href="/terms" className="hover:text-primary">Uslovi korištenja</Link>
            <Link href="/contact" className="hover:text-primary">Kontakt</Link>
          </div>
        </div>
      </div>
    </footer>
